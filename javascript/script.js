...
function updateTimer() {
  const targetDate = new Date("oCTOBER 12, 2024 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543814809265'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543816023627'; // Número para el primer botón
  const recipientNumber2 = '543814809265'; // Número para el segundo botón
